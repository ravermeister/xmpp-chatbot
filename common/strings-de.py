...
class StaticAnswers:
	...
	def __init__(self, nick=""):
		...
		self.possible_answers = {
			...
			'15': '%s uns fehlt nurnoch ein Kampflied und Uniformen und im Knopfloch tragen wir eine rote Nelke, aber keine aus Plastik den die ist was für Clowns. Und Clowns sind in einer ganz anderen Gewerkschaft.',
