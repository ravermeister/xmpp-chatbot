...
class StaticAnswers:
	...
	def __init__(self, nick=""):
		...
		self.possible_answers = {
			...
			'12': '%s die Macht ist stark in meiner Familie. Mein Vater hat sie, ich habe sie, sogar meine Schwester hat sie.',
			'13': '%s ich liebe es, wenn ein Plan funktioniert.',
			'16': '%s, Konfuzius sagt: Frauen und Würmer mit Warzen, sind schwer zu verarzten.',
			...
			'19': '%s uns fehlt nurnoch ein Kampflied und Uniformen und im Knopfloch tragen wir eine rote Nelke, aber keine aus Plastik den die ist was für Clowns. Und Clowns sind in einer ganz anderen Gewerkschaft.',
			'20': '%s du hörst nur dein Erbsenhirn, wie es in deinem Kopf rumrollt!',
			'21': '%s Es steht ihnen Frei, zu schreien und zu brüllen. Aber es wird sie niemand hören.',
			'22': '%s ich steig nicht in ein Flugzeug.',
